...
import { LandingCmsFeatures } from "../app/admin/cms/tabs/FeaturesTab"
...
const ICONS: any = { Sparkles, BarChart3, Zap, Target, Users, Layout, Activity, Globe, ShieldCheck }
...
export function FeatureGrid({ content }: { content?: LandingCmsFeatures }) {
    const data = content || DEFAULT_FEATURES
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={cn(
                                    ...
                                    colorMap[feature.color as keyof typeof colorMap] || colorMap.indigo
                                )}>
