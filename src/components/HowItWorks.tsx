                ...
                <div className="text-center mb-20">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-black text-white outfit mb-6">
                            How It <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400">Works.</span>
                        </h2>
                        <p className="text-slate-400 text-lg max-w-2xl mx-auto font-medium">
                            From data sync to tactical optimization in five automated steps.
                        </p>
                    </motion.div>
                </div>
