    ...
    if (loading) {
        return (
            <div className="flex h-[60vh] flex-col items-center justify-center gap-4 text-slate-500">
                ...
                <p className="font-mono text-xs uppercase tracking-[0.3em] animate-pulse">Loading templates...</p>
            </div>
        )
    }
        ...
        <div className="space-y-8 pb-12">
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-indigo-400/60">Templates</p>
                        <h1 className="text-xl font-black text-white tracking-tight uppercase">
                            {view === 'library' ? 'Template Library' : 'Edit Template'}
                        </h1>
                    </div>
                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.2em]">AI Picks</span>
                                        </div>
                                        <h2 className="text-3xl font-black text-white tracking-tighter">Top Performing Templates</h2>
                                    </div>
                                    <button
            ...
            <div className="flex items-center justify-center gap-10 pt-8 opacity-20 group">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">Template Engine: Active</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">Version: Latest</span>
                </div>
            </div>
        </div>
    )
